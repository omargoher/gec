...
namespace GEC.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828214604_AddCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GEC.Domain.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GEC.Domain.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CartId", "VariantId")
                        .IsUnique()
                        .HasDatabaseName("ix_cart_items_cart_id_variant_id");

                    b.ToTable("cart_items", null, t =>
                        {
                            t.HasCheckConstraint("ck_cart_items_quantity_positive", "\"quantity\" >= 1");
                        });
                });
            ...
            modelBuilder.Entity("GEC.Domain.Entities.Cart", b =>
                {
                    b.HasOne("GEC.Domain.Entities.Customer", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("GEC.Domain.Entities.Cart", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("GEC.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("GEC.Domain.Entities.Cart", "Cart")
                        .WithMany("Items")
