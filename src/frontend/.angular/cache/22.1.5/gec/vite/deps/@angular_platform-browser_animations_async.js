...
import { Ec as Injector, Fn as Injectable, Hc as RuntimeError, Pc as NgZone, Tc as InjectionToken, Ti as performanceMarkFeature, Tl as ɵɵdefineInjectable, Ui as setClassMetadata, ar as RendererFactory2, cc as ANIMATION_MODULE_TYPE, fc as ChangeDetectionScheduler, fl as makeEnvironmentProviders, ol as inject, pc as DOCUMENT, qo as ɵɵinvalidFactory } from "./core-DK4zC9WD.js";
...
var AsyncAnimationRendererFactory = class AsyncAnimationRendererFactory {
	doc;
	delegate;
	zone;
	animationType;
	...
	loadingSchedulerFn = inject(ɵASYNC_ANIMATION_LOADING_SCHEDULER_FN, { optional: true });
	_engine;
	...
	loadImpl() {
		const loadFn = () => this.moduleImpl ?? import("./platform-browser-P-nwT-yV.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)).then((m) => m);
	...
	createRenderer(hostElement, rendererType) {
		...
		if (rendererType?.data?.["animation"] && !this._rendererFactoryPromise) this._rendererFactoryPromise = this.loadImpl();
